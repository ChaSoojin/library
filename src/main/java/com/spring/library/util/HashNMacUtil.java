...
public class HashNMacUtil {
	...
	public static final byte[] getHMAC(SecretKey sk, String algorithm, byte[] text)
	...
	public static final byte[] getHmacSHA1WithBytesKey(byte[] key, byte[] text)
